...
<main>
    ...
    <section class="login-section">
        <div class="login-box">
            <h2 style="border-radius:20px;color:green;background-color:rgba(26, 154, 14, 0.3);border-height:30px;">CUSTOMER LOGIN</h2>
           <br>
            <form action="custLogin" method="post">
                ...
                <div class="links">
                    <p>Forgot Password? <a href="Customer_Reg.jsp"><span>Register</span></a></p>
                </div>
            </form>
        </div>
    </section>
