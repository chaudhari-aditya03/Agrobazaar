...
<head>
    ...
    <title>Contact Us - Farming Management System</title>
...
<body>
        ...
        <nav>
            <ul class="nav-links">
               <li><a href="HomePage.jsp">Home</a></li>
                ...
                <li><a href="LoginPage.jsp">Dashboard</a></li>
    ...
    <main>
        <section class="contact-us">
            <h2>Contact Us</h2>
            <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d846.9323716932453!2d74.46093933544091!3d20.903802059179633!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdeef04875b6c27%3A0xb9b55ff007fa15d1!2sWF36%2BGHV%2C%20Deur%20Budruk%2C%20Maharashtra%20424302!5e0!3m2!1sen!2sin!4v1712828962206!5m2!1sen!2sin"
        width="100%" height="480" style="border:0;" allowfullscreen="" loading="lazy"
        referrerpolicy="no-referrer-when-downgrade"></iframe>

   <br>

            <p class="text1"><i>If you have any questions, feedback, or inquiries, feel free to reach out to us using the form below or through our contact information provided.</i></p>
            ...
            <div class="contact-container">
                ...
                <div class="contact-info">
                    <h3>Our Address</h3>
                    <p>123 Farming Lane, Agriculture City, India</p>

                    <h3>Email Us</h3>
                    <p>support@farmingsystem.com</p>
    ...
    <footer class="font">
        ...
        <div class="footer-bottom">
            <p>© 2024 Farming Management System | All Rights Reserved</p>
        </div>
    </footer>
</body>
</html>
